...
const HE = {
  ...
  "home.hoursCloseNextDay": "(סגירה למחרת)",
  "home.hoursOrderWindow":
    "ניתן לשלוח הזמנות רק בזמני הפעילות שמוגדרים לכל יום (כפי שמופיע ב«זמני עבודה»), כולל משמרות שחוצות חצות עד שעת הסגירה שהוגדרה. מחוץ לחלון לא ניתן להזמין.",
  ...
  "ui.doubleCheeseHint": "עד שתי שכבות (דבל)",
  "ui.toppingAddOne": "הוספת שכבה",
  "ui.toppingRemoveOne": "הסרת שכבה",
  ...
  "checkout.couponPh": "הקלידו קוד קופון",
...
const AR = {
  ...
  "home.hoursCloseNextDay": "(الإغلاق في اليوم التالي)",
  "home.hoursOrderWindow":
    "يمكن إرسال الطلبات فقط خلال أوقات العمل المعرّفة لكل يوم (كما في «ساعات العمل»)، بما فيها الورديات التي تتجاوز منتصف الليل حتى وقت الإغلاق المحدد. خارج هذه الفترة لا يمكن الطلب.",
  ...
  "ui.doubleCheeseHint": "حتى طبقتان (دبل)",
  "ui.toppingAddOne": "إضافة طبقة",
  "ui.toppingRemoveOne": "إزالة طبقة",
  ...
  "checkout.couponPh": "أدخل رمز الكوبون",
