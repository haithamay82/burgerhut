...
const HE = {
  ...
  "lang.he": "עברית",
  "lang.ar": "العربية",
  "theme.switch": "ערכת צבע",
  "theme.dark": "כהה",
  "theme.concrete": "בטון",
  "theme.darkShort": "כהה",
  "theme.concreteShort": "בטון",
  "theme.useSiteDefault": "ברירת האתר",
  ...
  "admin.employeeHint":
    "מצב עובד — גישה לניהול מלאי, שעות פעילות והזמנות היום בלבד (ללא היסטוריה).",
  "admin.employeeOrdersTitle": "הזמנות היום",
  "admin.employeeAutoRefreshHint":
    "ההזמנות להיום מתעדכנות אוטומטית כל כ־15 שניות כשהדף פתוח.",
  ...
  "admin.themeTitle": "ערכת צבע לאתר",
  "admin.themeHint":
    "בחרו רקע כהה או בטון לכל האתר. לקוחות יכולים גם לבחור בעצמם במסך הבית — הבחירה שלהם נשמרת במכשיר.",
  "admin.themeDark": "כהה (שחור)",
  "admin.themeConcrete": "בטון",
  "admin.themeSaveOk": "ערכת הצבע של האתר עודכנה.",
  "admin.themeSaveErr": "שמירת ערכת הצבע נכשלה.",
  "admin.themeSaving": "שומר…",
  "admin.themeCurrentSite": "ברירת האתר כרגע: {theme}",
...
const AR = {
  ...
  "lang.he": "עברית",
  "lang.ar": "العربية",
  "theme.switch": "سمة الألوان",
  "theme.dark": "داكن",
  "theme.concrete": "خرسانة",
  "theme.darkShort": "داكن",
  "theme.concreteShort": "خرسانة",
  "theme.useSiteDefault": "افتراضي الموقع",
  ...
  "admin.employeeHint":
    "وضع الموظف — الوصول لإدارة المخزون، ساعات العمل وطلبات اليوم فقط (بدون أرشيف).",
  "admin.employeeOrdersTitle": "طلبات اليوم",
  "admin.employeeAutoRefreshHint":
    "تُحدَّث طلبات اليوم تلقائياً كل نحو 15 ثانية عندما تبقى الصفحة مفتوحة.",
  "admin.secretStorageHint":
  ...
  "admin.themeTitle": "سمة ألوان الموقع",
  "admin.themeHint":
    "اختاروا خلفية داكنة أو خرسانية لكل الموقع. يمكن للعملاء أيضاً الاختيار بأنفسهم في الصفحة الرئيسية — يُحفظ اختيارهم على الجهاز.",
  "admin.themeDark": "داكن (أسود)",
  "admin.themeConcrete": "خرسانة",
  "admin.themeSaveOk": "تم تحديث سمة ألوان الموقع.",
  "admin.themeSaveErr": "فشل حفظ سمة الألوان.",
  "admin.themeSaving": "جارٍ الحفظ…",
  "admin.themeCurrentSite": "افتراضي الموقع حالياً: {theme}",
