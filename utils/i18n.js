...
const HE = {
  ...
  "success.waActionDetailWithOrder":
    "התשלום התקבל וההזמנה נרשמה במערכת. כדי שהמסעדה תקבל את פירוט ההזמנה (מס׳ {order}) ותוכלו להמשיך לשוחח איתנו שם — חובה ללחוץ על הכפתור למטה ולשלוח את ההודעה בווטסאפ.",
  "success.waActionDetailNoOrder":
    "התשלום התקבל וההזמנה נרשמה במערכת. כדי שהמסעדה תקבל את פירוט ההזמנה ותוכלו להמשיך לשוחח איתנו בווטסאפ — חובה ללחוץ על הכפתור למטה ולשלוח את ההודעה.",
  ...
  "admin.pushPerDeviceHint":
    "חשוב: כל מכשיר בנפרד — התראה בטלפון רק אחרי «רשום Push» בטלפון. בכל דפדפן נשמר מנוי אחד (רישום חוזר מעדכן, לא מוסיף עותקים). אם מופיע מספר גבוה ממספר המכשירים: מחקו את כל המנויים פעם אחת ואז רשמו מחדש.",
...
const AR = {
  ...
  "success.waActionDetailWithOrder":
    "تم استلام الدفع وتسجيل الطلب. ليتلقى المطعم تفاصيل الطلب (رقم {order}) ويمكنكم متابعة الحديث معنا هناك — يجب الضغط على الزر أدناه وإرسال الرسالة في واتساب.",
  "success.waActionDetailNoOrder":
    "تم استلام الدفع وتسجيل الطلب. ليتلقى المطعم تفاصيل الطلب ويمكنكم متابعة الحديث معنا في واتساب — يجب الضغط على الزر أدناه وإرسال الرسالة.",
  "success.couponThenWhatsApp":
  ...
  "admin.pushPerDeviceHint":
    "مهم: كل جهاز على حدة — للهاتف يلزم «تسجيل Push» من الهاتف. لكل متصفح اشتراك واحد (إعادة التسجيل تُحدّث فلا تتراكم نسخ). إذا ظهر رقم أكبر من عدد الأجهزة: احذفوا كل الاشتراكات مرة ثم سجّلوا من جديد.",
  "admin.pushStatusLine":
