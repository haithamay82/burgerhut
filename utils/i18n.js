...
const HE = {
  ...
  "admin.sliderKvHint":
    "העלאה מהטלפון: מיד עם בחירת התמונה מתחילה העלאה לשרת. אם ההעלאה נכשלה — לחצו על «העלה לסליידר מהטלפון». הקוד נשמר גם בזיכרון המכשיר (localStorage) כדי שאחרי יציאה למצלמה הדף יוכל להתחבר שוב. בפרודקשן חובה Redis/KV. מקומית: תיקיית data/.",
...
const AR = {
  ...
  "admin.sliderKvHint":
    "الرفع من الهاتف: عند اختيار الصورة يبدأ الرفع مباشرة. إذا فشل — اضغطوا «رفع للشريط من الهاتف». يُحفظ الرمز أيضاً في ذاكرة الجهاز (localStorage) ليعود الاتصال بعد الخروج إلى الكاميرا. في الإنتاج يلزم Redis/KV. محلياً: مجلد data/.",
