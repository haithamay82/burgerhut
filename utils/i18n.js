...
const HE = {
  ...
  "admin.sliderKvHint":
    "העלאה מהטלפון: מיד עם בחירת התמונה מתחילה העלאה לשרת (לא צריך ללחוץ קודם על הכפתור). אם ההעלאה נכשלה — לחצו על «העלה לסליידר מהטלפון». בפרודקשן ב-Vercel חובה Redis/KV. בפיתוח מקומי נשמר תחת תיקיית data/ (לא ב-Git).",
...
const AR = {
  ...
  "admin.sliderKvHint":
    "الرفع من الهاتف: عند اختيار الصورة يبدأ الرفع مباشرة (لا حاجة للضغط على الزر أولاً). إذا فشل الرفع — اضغطوا «رفع للشريط من الهاتف». في الإنتاج على Vercel يلزم Redis/KV. محلياً يُحفظ تحت مجلد data/ (ليس في Git).",
