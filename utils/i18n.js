...
const HE = {
  ...
  "home.hoursOrderWindow":
    "ניתן לשלוח הזמנות משעה 10:00 עד שעת הסגירה באותו יום, בכל יום שהמסעדה פתוחה (כפי שמופיע ב«זמני עבודה»). מחוץ לחלון הזה לא ניתן להזמין.",
...
const AR = {
  ...
  "home.hoursOrderWindow":
    "يمكن إرسال الطلبات من الساعة 10:00 حتى وقت الإغلاق في ذلك اليوم، في كل يوم يعمل فيه المطعم (كما في «ساعات العمل»). خارج هذه الفترة لا يمكن الطلب.",
